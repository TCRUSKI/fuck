...
function awarn_menu()
	...
	AWarn.MenuFrame.WarningsList.OnRowRightClick = function( PlayerList, line )
		...
		DropDown:AddOption("Copy To Clipboard", function()
			MsgC( Color(255,0,0), "AWarn: ", Color(255,255,255), "This feature is not available in the free version of AWarn2!\n")
			LocalPlayer():ChatPrint( "AWarn: This feature is not available in the free version of AWarn2!")
		end )
		DropDown:Open()
	end
...
function awarn_optionsmenu()
	...
	MenuPanelSlider1:SetValue( GetConVar("awarn_kick_threshold"):GetInt() )
	MenuPanelSlider1.Think = function( MenuPanelSlider1 )
		...
		if tonumber(MenuPanelSlider1.TextArea:GetValue()) ~= GetConVar("awarn_kick_threshold"):GetInt() then
		...
		if GetConVar("awarn_kick_threshold"):GetInt() ~= MenuPanelSlider1:GetValue() then
			MenuPanelSlider1:SetValue( GetConVar("awarn_kick_threshold"):GetInt() )
		end
	end
	...
	MenuPanelSlider2:SetValue( GetConVar("awarn_ban_threshold"):GetInt() )
	MenuPanelSlider2.Think = function( MenuPanelSlider2 )
		...
		if tonumber(MenuPanelSlider2.TextArea:GetValue()) ~= GetConVar("awarn_ban_threshold"):GetInt() then
			net.Start("awarn_changeconvar")
		...
		if GetConVar("awarn_ban_threshold"):GetInt() ~= MenuPanelSlider2:GetValue() then
			MenuPanelSlider2:SetValue( GetConVar("awarn_ban_threshold"):GetInt() )
		end
	end
	...
	MenuPanelSlider3:SetValue( GetConVar("awarn_ban_time"):GetInt() )
	MenuPanelSlider3.Think = function( MenuPanelSlider3 )
		...
		if tonumber(MenuPanelSlider3.TextArea:GetValue()) ~= GetConVar("awarn_ban_time"):GetInt() then
			net.Start("awarn_changeconvar")
		...
		if GetConVar("awarn_ban_time"):GetInt() ~= MenuPanelSlider3:GetValue() then
			MenuPanelSlider3:SetValue( GetConVar("awarn_ban_time"):GetInt() )
		end
	end
